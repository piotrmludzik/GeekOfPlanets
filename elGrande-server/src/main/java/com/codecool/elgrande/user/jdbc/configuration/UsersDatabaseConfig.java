package com.codecool.elgrande.user.jdbc.configuration;
...
@EnableJpaRepositories(basePackages="com.codecool.elgrande.user.jdbc.repository",
...
public class UsersDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean memberEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.codecool.elgrande.user.model")
                .build();
    }
