package com.codecool.elgrande.game.jdbc.configuration;
...
@EnableJpaRepositories(basePackages="com.codecool.elgrande.game.jdbc.repository",
...
public class GameDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean gameEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.codecool.elgrande.game.model")
                .build();
    }
    @Primary
    @Bean
