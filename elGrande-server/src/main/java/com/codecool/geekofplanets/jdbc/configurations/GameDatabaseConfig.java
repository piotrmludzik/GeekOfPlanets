package com.codecool.geekofplanets.jdbc.configurations;
...
@EnableJpaRepositories(basePackages="com.codecool.elgrande.jdbc.repository.game",
...
public class GameDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean gameEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.codecool.elgrande.model.game")
                .build();
    }
    @Primary
    @Bean
